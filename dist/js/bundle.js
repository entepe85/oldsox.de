...
(function () {
    var pageScrollers = document.querySelectorAll('.nav__menu a'),
        MenuSpy = __webpack_require__(5),
        mainNav = document.querySelector('.nav__menu'),
        menuSpy = new MenuSpy(mainNav, {
        threshold: 115
    }),
        TweenLite = __webpack_require__(0),
        scrollTo = __webpack_require__(4),
    ...
    try {
        var _loop = function _loop() {
            var scroller = _step.value;

            scroller.addEventListener('click', function (ev) {
                ev.preventDefault();
                var targetName = scroller.getAttribute('href'),
        ...
        for (var _iterator = pageScrollers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            _loop();
        }
    } catch (err) {
...
(function (global, factory) {
  ( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : global.MenuSpy = factory();
})(undefined, function () {
  'use strict';
